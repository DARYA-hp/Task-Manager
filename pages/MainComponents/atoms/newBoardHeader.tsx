...
function NewBoardHeader() {
  ...
  return (
    <>
      <div>
        <div className="flex flex-row items-center gap-4 mt-14 mr-6">
          ...
          <ul className="flex flex-row gap-4">
            <li onClick={() => router.push('/NewBoardList')}
              className="cursor-pointer border-l-2 flex flex-row gap-2 items-center pl-4 text-xl transition-all duration-200"
            ...
            <li onClick={() => router.push('/NewBoard')}
              className="cursor-pointer border-l-2 flex flex-row gap-2 items-center pl-4 text-xl transition-all duration-200"
              style={{ borderColor: 'gray', color: 'inherit', borderBottom: 'none', }}
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = primaryColor;
            ...
            <li className="cursor-pointer border-l-2 flex flex-row gap-2 items-center pl-4 text-xl transition-all duration-200"
              style={{ borderColor: 'gray', color: 'inherit', borderBottom: 'none', }}
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = primaryColor;
                e.currentTarget.style.color = primaryColor;
      ...
      <Modal isOpen={sharePro} onClose={() => setSharePro(true)} title="">
        <ShareProject />
      </Modal>
    </>
  )
}
export default NewBoardHeader