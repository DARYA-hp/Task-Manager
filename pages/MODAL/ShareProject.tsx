        ...
        <>
            <div className="flex flex-col gap-4 items-center">
                ...
                <div className="flex mt-4  flex-row rounded-xl justify-between w-full bg-[#F0F1F3]">
                    ...
                    <button style={{backgroundColor : primaryColor}} className=" text-white rounded-l-xl py-3 px-10 ">ارسال</button>
                </div>
                ...
                <div className=" w-full flex flex-col gap-2 mt-4">
                    ...
                    <div className=" flex flex-row justify-between ">
                        ...
                        <button className=" border-2  px-4 rounded-md border-[#E9EBF0]">دسترسی کامل</button>
                    </div>
                    <div className=" flex flex-row items-center justify-between">
                        <div className=" flex flex-row gap-2 justify-center text-center items-center">
                            ...
                            <p className=" text-[21px]">Sararahimi@gmail.com</p>
                        </div>
